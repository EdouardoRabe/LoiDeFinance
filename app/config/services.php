...
use app\models\TicketRechercheModel;
use app\models\TicketDashboardModel;
use app\models\DiscussionTicketModel;
use app\models\EvaluationTicketModel;
...
$dsn = 'mysql:host=' . $config['database']['host'] .
    (isset($config['database']['port']) ? ';port=' . $config['database']['port'] : '') .
...
// Mapping des modèles liés aux tickets
