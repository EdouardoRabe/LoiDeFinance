...
$app->set('DOLIBARR_API_KEY', 'ef9b4009055b9ccacdcbb98f756f337b55667e2d'); // if flight should send a content length header');
$app->set('DOLIBARR_API_URL', 'http://localhost/dolibarr-21.0.1/htdocs/api/index.php/'); // if flight should send a content length header
/* 
