<?php $pageTitle = (function_exists('t') ? t('page.depenses.title') : 'Dépenses') . ' — ' . (function_exists('t') ? t('app.title') : 'Loi de Finances'); include __DIR__ . '/partials/header.php'; ?>
    <link rel="stylesheet" href="assets/css/tooltip.css">
    <h1><?= htmlspecialchars(function_exists('t') ? t('page.depenses.title') : 'Dépenses') ?></h1>
    <p class="section-desc"><?= htmlspecialchars(function_exists('t') ? t('desc.depenses') : 'Visualisez la répartition des dépenses publiques par type et catégorie.') ?></p>
